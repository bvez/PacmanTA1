...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        if (len(state[1]) ==0):
        #si esta condición se cumple, el pacman ya comió en las 4 esquinas,
        #para regresar a su posicion inicial, se agregan las filas 308 y 309.
        #Dado que la condición del problema es que el pacman haya comido y finaliza,
        #no se muestra cómo el pacman regresa a su posición inicial, por ende,
